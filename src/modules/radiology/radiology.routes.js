...
radiologyRouter.patch('/update-citizen/:id', uploadCloudFile(fileTypes.allowedAttachments).array('images',2),validation(updateRadiologyValidation), updateRadiology)
